...
class TriviaTestCase(unittest.TestCase):
    ...
    def populatedb(self, db):
        ...
        question1 = Question(question="oxigen symbol",
                             answer="o", category_id=1, difficulty=1)
        question2 = Question(question="sodium symbol",
                             answer="na", category_id=1, difficulty=2)
        question3 = Question(question="water composition",
                             answer="h2o", category_id=1, difficulty=3)
        question4 = Question(question="hydrogen peroxide composition",
                             answer="h2o2", category_id=1, difficulty=4)
        question5 = Question(question="vitamin c composition",
                             answer="c6h8o6", category_id=1, difficulty=5)

        category2 = Category(type="dragon ball")
        question6 = Question(question="goku last name",
                             answer="son", category_id=2, difficulty=1)
        question7 = Question(question="goku 2nd son",
                             answer="goten", category_id=2, difficulty=2)
        question8 = Question(question="saiyan prince",
                             answer="vegeta", category_id=2, difficulty=3)
        question9 = Question(question="goku mom name",
                             answer="gine", category_id=2, difficulty=5)
        question10 = Question(question="frieza dad name",
                              answer="cold", category_id=2, difficulty=4)

        category3 = Category(type="latam sports")
        question11 = Question(question="best international soccer \
                              team from south america",
                              answer="boca", category_id=3, difficulty=1)
        question12 = Question(question="best ecuadorian soccer team",
                              answer="ldu", category_id=3, difficulty=2)
        question13 = Question(question="2nd best ecuadorian soccer team",
                              answer="idv", category_id=3, difficulty=3)
        question14 = Question(question="Ecuadorian olympics gold winner  \
                              in Athlanta '96",
                              answer="jefferson perez", category_id=3,
                              difficulty=5)
        question15 = Question(question="2nd best soccer team in argentina",
                              answer="river", category_id=3, difficulty=4)
        ...
        questions3 = [question11, question12,
    ...
    def setUp(self):
        ...
        # self.database_path = "postgres://{}@{}/{}".format(
        #     'marlon:admin','localhost:5442', self.database_name)
    ...
    def test_get_categories(self):
        ...
        self.assertTrue(lambda x: x["type"] ==
                        "dragon ball" in data["categories"])
    ...
    def test_get_paginated_questions(self):
        ...
        self.assertEqual(len(data["questions"]),
                         total_paginated_questions_expected)
        self.assertEqual(len(data["categories"]), total_categories_expected)
    ...
    def test_questions_by_category(self):
        ...
        res = self.client().get(
            f"/categories/{expected_category_id}/questions")
        data = json.loads(res.data)
    ...
    def test_quizzes_return_different_question_at_time_no_category(self):
        ...
        self.assertEqual(data2["previousQuestions"],
                         params2["previous_questions"])
